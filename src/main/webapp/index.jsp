...
<body>
	...
	<nav>
		<div class="nav-wrapper">
			<a href="#" class="brand-logo">Blood Donation - Links</a>
		</div>
	</nav>
		...
		<div class="col s12 m8 l6">
			<ul class="collection">
			 	<li class="collection-item dismissable">
		        	<div><a href="pages/search.html">Search for donor</a>
		        		<a href="pages/search.html" class="secondary-content"><i class="material-icons">input</i></a>
		        	</div>
		        </li>
		        <li class="collection-item dismissable">
		        	<div><a href="pages/register.html">Register Yourself</a>
		        		<a href="pages/register.html" class="secondary-content"><i class="material-icons">input</i></a>
		        	</div>
		        </li>
		        <!-- <li class="collection-item dismissable">
		        	<div>Compare tags
